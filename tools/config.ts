...
export const APP_ASSETS: InjectableDependency[] = [
  { src: `${ASSETS_SRC}/css/bootstrap.min.css`, inject: true, dest: CSS_DEST },
  { src: `${ASSETS_SRC}/css/font-awesome.min.css`, inject: true, dest: CSS_DEST },
  { src: `${ASSETS_SRC}/css/grayscale.css`, inject: true, dest: CSS_DEST },
  { src: `${ASSETS_SRC}/main.css`, inject: true, dest: CSS_DEST },
  { src: `${ASSETS_SRC}/js/jquery.js`, inject: 'libs', dest: JS_DEST },
  { src: `${ASSETS_SRC}/js/bootstrap.min.js`, inject: 'libs', dest: JS_DEST },
  { src: `${ASSETS_SRC}/js/jquery.easing.min.js`, inject: 'libs', dest: JS_DEST },
  { src: `${ASSETS_SRC}/js/grayscale.js`, inject: 'libs', dest: JS_DEST }];
